                ...
                {auditLogs.map((log, idx) => (
                  <div key={log.id || idx} style={{ padding: '10px 12px', borderBottom: '1px solid #f0f0f0', fontSize: 13 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                      ...
                      <span style={{ color: '#bbb', fontSize: 11 }}>{log.created_at ? new Date(log.created_at.replace(' ', 'T') + 'Z').toLocaleString('zh-CN', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' }) : ''}</span>
                    </div>
